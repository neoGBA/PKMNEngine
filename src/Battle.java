...
public class Battle {
	...
	public void startBattle() {
		...
		Player.addPokemonToParty(PokemonList.get(0));
		//adds move to pokemon
		Player.getPokemon(0).addMoves(MoveList.get(0));
		
		System.out.println(Player.getPokemon(0).getName());
		System.out.println(Player.getPokemon(0).getLevel());
		System.out.println(Player.getPokemon(0).getTypeOne());
		System.out.println(Player.getPokemon(0).getTypeTwo());
		
		//Setup Opponent Info & Party
		Joey.setOpponentName("Youngster Joey");
		Joey.addPokemonToParty(PokemonList.get(17));
